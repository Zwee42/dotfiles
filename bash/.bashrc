...
alias btc='rfk && bluetoothctl connect F8:AB:E5:1C:98:EB'
alias btdc='bluetoothctl disconnect F8:AB:E5:1C:98:EB'
alias bashrl='source ~/.bashrc'
alias nh='nvim ~/.config/hypr/hyprland.conf'
alias opdf='chromium --new-window '
...
ngxlink() {
        local site=$1
        local src="/etc/nginx/sites-available/$site"
        local dest="/etc/nginx/sites-enabled/$site"

        if [ -z "$site" ]; then
                echo "Usage: ngxlink <site-name>"                                            
                return 1                                                                     
        fi                                                                                   
        ...
        sudo ln -sf "$src" "$dest" && echo "Linked $site"                                    
}         
